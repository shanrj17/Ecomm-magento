...
define([
    ...
    $.widget("codazon.cdzMediabrowser", {
        ...
        selectFile: function(event) {
            ...
            this.element.find('#delete_files, #insert_files').toggleClass(this.options.hidden, !fileRow.is('.selected'));
                ...
                actions: {
                    confirm: function () {
                        return $.ajax({
                            ...
                            self.reload();
                            $(window).trigger('fileDeleted.mediabrowser', { ids: self.activeNode.id });
                        }, this));
                    },
                    cancel: function () {
                        return false;
                ...
                actions: {
                    confirm: function () {
                        ...
                        return $.ajax({
                            ...
                            $(window).trigger('fileDeleted.mediabrowser', { ids: ids });
                        }, this));
                    },
                    cancel: function () {
                        return false;
